document.addEventListener('DOMContentLoaded', () => {
  ...
  if (typeof particlesJS !== 'undefined') {
    particlesJS('particles-js', {
      particles: {
        ...
        line_linked: { enable: true, distance: 150, color: '#E8A0B4', opacity: 0.1, width: 1 },
  ...
  (function createPetals() {
    ...
    for (let i = 0; i < petalCount; i++) {
      ...
      petal.style.background = ['#E8A0B4', '#F5C6D4', '#D4A0B8', '#B880A0', '#FFF8FA'][Math.floor(Math.random() * 5)];
  ...
  const gradients = [
    'linear-gradient(135deg, #E8A0B4, #F5C6D4)',
    'linear-gradient(135deg, #D4A0B8, #E8A0B4)',
    'linear-gradient(135deg, #B880A0, #D4A0B8)',
    'linear-gradient(135deg, #F5C6D4, #FFF8FA)',
    'linear-gradient(135deg, #E8A0B4, #B880A0)',
    'linear-gradient(135deg, #D4A0B8, #FFF8FA)'
  ];
